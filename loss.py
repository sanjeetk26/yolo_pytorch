...
class YoloLoss(nn.Module):
    def __init__(self, S=7, B=2, C=20): #B=2 means output 2 boxes fro each cell
    ...
    def forward(self, predictions, target):
        ...
        ious=torch.cat([iou_b1.unsqeeze(0), iou_b2.unsqueeze(0)], dim=0)
        ...
        object_loss=self.mse(torch.flatten(exists_box*pred_box),torch.flatten(esists_box*target[...,20:21]))
